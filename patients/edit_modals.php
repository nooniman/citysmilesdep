...
<body>
    ...
    <!-- edit Dental History Modal -->
    <div id="editdentalHistoryModal" class="modal">
        <div class="modal-content">
            ...
            <table class="medical-history-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="radio" name="under_medical_treatment" id="under_medical_treatment_yes"
                                value="yes"
                                onclick="toggleOtherOption('under_medical_treatment', 'under_medical_treatment_other')">
                        </td>
                        <td><input type="radio" name="under_medical_treatment" id="under_medical_treatment_no"
                                value="no"
                                onclick="toggleOtherOption('under_medical_treatment', 'under_medical_treatment_other')">
                        </td>
                        <td>
                            <div id="under_medical_treatment_other" class="other-option" style="display: none;">
                                <textarea name="medical_condition" id="medical_condition" rows="3" cols="30"
                    ...
                    <tr>
                        ...
                        <td><input type="radio" name="surgical_operation" id="surgical_operation_yes" value="yes"
                                onclick="toggleOtherOption('surgical_operation', 'surgical_operation_other')"></td>
                        <td><input type="radio" name="surgical_operation" id="surgical_operation_no" value="no"
                                onclick="toggleOtherOption('surgical_operation', 'surgical_operation_other')"></td>
                        <td>
                            <div id="surgical_operation_other" class="other-option" style="display: none;">
                                <textarea name="surgical_operation_details" id="surgical_operation_details" rows="3"
                                    cols="30" placeholder="Type your answer here"></textarea>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>4. Have you ever been hospitalized?</td>
                        <td><input type="radio" name="hospital_admission" id="hospital_admission_yes" value="yes"
                                onclick="toggleOtherOption('hospital_admission', 'hospital_admission_other')"></td>
                        <td><input type="radio" name="hospital_admission" id="hospital_admission_no" value="no"
                                onclick="toggleOtherOption('hospital_admission', 'hospital_admission_other')"></td>
                        <td>
                            <div id="hospital_admission_other" class="other-option" style="display: none;">
                                <textarea name="hospital_admission_reason" id="hospital_admission_reason" rows="3"
                                    cols="30" placeholder="Type your answer here"></textarea>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="radio" name="taking_medications" id="taking_medications_yes" value="yes"
                                onclick="toggleOtherOption('taking_medications', 'taking_medications_other')"></td>
                        <td><input type="radio" name="taking_medications" id="taking_medications_no" value="no"
                                onclick="toggleOtherOption('taking_medications', 'taking_medications_other')"></td>
                        <td>
                            <div id="taking_medications_other" class="other-option" style="display: none;">
                                <textarea name="medication_details" id="medication_details" rows="3" cols="30"
                                    placeholder="Type your answer here"></textarea>
                            </div>
                        </td>
                    </tr>
